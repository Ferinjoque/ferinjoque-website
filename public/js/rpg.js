...
const SUPABASE_PROJECT_URL = 'SUPABASE_URL'; // <<<<<<< REPLACE THIS
const SUPABASE_ANON_KEY = 'SUPABASE_ANON_KEY';    // <<<<<<< REPLACE THIS
let supabase = null;

if (SUPABASE_PROJECT_URL === 'SUPABASE_URL' || SUPABASE_ANON_KEY === 'SUPABASE_ANON_KEY') {
